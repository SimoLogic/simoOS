...
// 3. Server Action consulta PostgreSQL con filtro tenantId
 ...
 * @param tenantId   - Tenant ID (obtenido de usePmoStore, no hardcodeado)
 * 
...
export function usePmoBoard(
  ...
  useEffect(() => {
    ...
    // const result = await fetchPmoBoard({ boardId, tenantId });
