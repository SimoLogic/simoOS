...
import type { ReportTree, MetricMap, Measure } from '@/lib/commercial-activity/aggregation/types';
import type { YearMonth } from '@/lib/commercial-activity/parsing/types';
import { sumMonths } from '@/lib/commercial-activity/aggregation/sumMonths';
import { METRICS, MONTH_NAMES, type MetricKey } from '@/lib/commercial-activity/config/metrics';
import { BRANCH_ORDER } from '@/lib/commercial-activity/config/roster';
