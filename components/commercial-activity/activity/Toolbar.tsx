...
import type { Branch } from '@/lib/commercial-activity/config/roster';
import { ymLabel } from '@/lib/commercial-activity/aggregation/months';
...
export default function Toolbar({
  ...
  return (
    <div className="table-tools">
      ...
      {/* La vista "Por Loan Officer" cruza todos los branches por diseño -- el filtro de Branch no aplica y se oculta. */}
      {view !== 'loanOfficer' && (
        <>
