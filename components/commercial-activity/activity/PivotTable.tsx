...
import type { ReportTree, ReportTreeBranch, ReportTreeMetricGroup, Measure } from '@/lib/commercial-activity/aggregation/types';
import type { YearMonth } from '@/lib/commercial-activity/parsing/types';
import { METRICS, MONTH_NAMES } from '@/lib/commercial-activity/config/metrics';
