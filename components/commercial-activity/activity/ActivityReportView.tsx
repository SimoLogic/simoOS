...
import { buildLoanOfficerTree } from '@/lib/commercial-activity/aggregation/buildLoanOfficerTree';
...
import { METRICS, type MetricKey } from '@/lib/commercial-activity/config/metrics';
...
import LoanOfficerTable from '@/components/commercial-activity/activity/LoanOfficerTable';
...
export function ActivityReportView() {
  ...
  // Etapa 12: criterio de orden de la vista "Por Loan Officer" -- solo importa cuando view==='loanOfficer'.
