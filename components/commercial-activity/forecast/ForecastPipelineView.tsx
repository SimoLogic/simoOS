...
import { HOMESI_TENANT_ID } from '@/lib/commercial-activity/config/tenant';
import {
  splitHealthyTotal,
  ...
  type DateRange,
} from '@/lib/commercial-activity/pipeline/aggregate';
import type { PipelineLoan, ResolvedLoan } from '@/lib/commercial-activity/pipeline/types';
import SummaryCards, { type SummaryBlock } from '@/components/commercial-activity/forecast/SummaryCards';
import MilestoneCascade from '@/components/commercial-activity/forecast/MilestoneCascade';
import PivotTable, { type BranchForecastRow } from '@/components/commercial-activity/forecast/PivotTable';
import UploadButton, { PIPELINE_FILE_INPUT_ID } from '@/components/commercial-activity/forecast/UploadButton';
import DateRangeInput from '@/components/commercial-activity/forecast/DateRangeInput';
 ...
 * sesión.
 */
export function ForecastPipelineView() {
  ...
  async function handleFileSelected(file: File) {
    ...
    try {
      ...
      const res = await fetch('/api/commercial-activity/pipeline/parse', { method: 'POST', body: formData });
